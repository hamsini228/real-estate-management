...
const Profile = ({ user, setUser }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if ((formData.city && !alphaRegex.test(formData.city)) ||
            ...
            setNotification({ msg: 'City and State must contain only alphabets and spaces.', type: 'danger' });
            return;
        }
        if (formData.address && !addressRegex.test(formData.address)) {
            setNotification({ msg: 'Address can contain alphabets, numbers, and common punctuation.', type: 'danger' });
            return;
        }
